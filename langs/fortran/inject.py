...
if(len(sys.argv) == 4):
	...
	raise ValueError("Incorrect number of arguments! Parse script takes exactly two arguments: filepath variable_name ")
...
def Inject():
	...
	for i in range(start,end):
		lineNum = i+1
		if(lines[i] == "") or (variable_name not in lines[i]):
			continue
